...
public class ApiGlobalErrorResponse {
    ...
    public static ApiGlobalErrorResponse create(int statusCode,
        ...
        var response = new ApiGlobalErrorResponse();
    ...
    public static ApiGlobalErrorResponse locked(String type, String identifier) {
        ...
        var msg = "The server is currently unable to handle the request due to concurrent modification " + details
                + ", please try again";
    ...
    public static ApiGlobalErrorResponse unAuthorized(final String defaultUserMessage) {
        var msgCode = "error.msg.not.authorized";
        final var errors = List.of(ApiParameterError.generalError(msgCode, defaultUserMessage));
    ...
    public static ApiGlobalErrorResponse domainRuleViolation(final String globalisationMessageCode,
    ...
    public static ApiGlobalErrorResponse dataIntegrityError(final String globalisationMessageCode,
                                                            final String defaultUserMessage,
    ...
    public static ApiGlobalErrorResponse notFound(final String globalisationMessageCode,
                                                  final String defaultUserMessage,
                                                  final Object... defaultUserMessageArgs) {
        var msg = "The requested resource is not available.";
        final List<ApiParameterError> errors = new ArrayList<>();
    ...
    public static ApiGlobalErrorResponse badClientRequest(final String globalisationMessageCode,
                                                          final String defaultUserMessage,
    ...
    public static ApiGlobalErrorResponse jobIsDisabled(final String globalisationMessageCode,
                                                       final String defaultUserMessage) {
        return create(SC_FORBIDDEN, globalisationMessageCode, defaultUserMessage, defaultUserMessage);
    }

    public static ApiGlobalErrorResponse serverSideError(final String globalisationMessageCode,
                                                         final String defaultUserMessage,
                                                         final Object... defaultUserMessageArgs) {
        var msg = "An unexpected error occured on the platform server.";
        final List<ApiParameterError> errors = new ArrayList<>();
        errors.add(ApiParameterError.generalError(globalisationMessageCode, defaultUserMessage, defaultUserMessageArgs));
    ...
    public static ApiGlobalErrorResponse serviceUnavailable(final String globalisationMessageCode,
                                                            final String defaultUserMessage,
                                                            final Object... defaultUserMessageArgs) {
